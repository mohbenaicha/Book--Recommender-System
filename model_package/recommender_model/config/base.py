...
TRAINED_LE_DIR = PACKAGE_ROOT / "fitted_le"
TRAINED_MODEL_DIR = PACKAGE_ROOT / "fitted_model"
TRAINED_SLU_DIR = PACKAGE_ROOT / "fitted_slu"
...
class AppConfig(BaseModel):
    ...
    users_string_lookup_name: str
    books_string_lookup_name: str
...
class ModelConfig(BaseModel):
    ...
    batch_size: int
    epochs: int
    k_recommendations: int
    second_embed_dim: int
